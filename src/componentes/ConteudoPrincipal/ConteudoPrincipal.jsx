...
const ConteudoPrincipal = () => {
  return (
    <main className='h-[100%] w-[100%] flex flex-col md:flex-row lg:px-[150px] items-center justify-center'> 
        <div className='w-[60%] flex flex-col gap-[30px] animate-slideInLeft items-center text-center justify-center drop-shadow-md	'>
            <h2 className='sm:text-7xl text-6xl text-cor-azul-secundaria font-bold '>Dr. Willer Carvalho</h2>
            <h2 className='text-cor-azul-secundaria text-2xl sm:text-5xl'>Cirurgião-dentista</h2>
            ...
            <p className='md:text-2xl text-cor-marrom'>" Dedicado a transformar sorrisos e promover o bem-estar oral, combinando habilidade técnica com cuidado individualizado para criar resultados que inspiram confiança e felicidade. " </p>
